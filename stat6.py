...
def send_email(name, message):
    ...
    try:
        ...
        return True, "تم إرسال رسالتك بنجاح! سنتواصل معك قريباً."
    ...
    try:
        ...
        if factors:
            ...
            for factor_name, items in factors.items():
                ...
                doc.add_paragraph(f'المتوسط: {factor_data.mean():.2f}')
                doc.add_paragraph(f'الوسيط: {factor_data.median():.2f}')
                doc.add_paragraph(f'الانحراف المعياري: {factor_data.std():.2f}')
